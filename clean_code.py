...
# TESTING DATA df -------------------------------------------------------------------------------------
df=pd.read_csv("C:\\Users\\Pranab Mahata\\Desktop\\Completed_Project\\DpML\\Training.csv")
...
# TRAINING DATA tr --------------------------------------------------------------------------------
tr=pd.read_csv("C:\\Users\\Pranab Mahata\\Desktop\\Completed_Project\\DpML\\Testing.csv")
...
w2 = Label(root, justify=LEFT, text="by Pranab Mahata", fg="white", bg="blue")
